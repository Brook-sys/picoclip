...
func (s *Server) Mount(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /partials/runs", s.handleWebPartialsRuns)
	...
	mux.HandleFunc("POST /runtimes/{id}/basic-config", s.handleWebPostRuntimeBasicConfig)
	...
	mux.HandleFunc("POST /tasks/{id}/delete", s.handleWebDeleteTask)
	mux.HandleFunc("POST /tasks/cleanup-finished", s.handleWebCleanupFinishedTasks)
	mux.HandleFunc("POST /runs/{id}/delete", s.handleWebDeleteRun)
	mux.HandleFunc("POST /runs/cleanup-finished", s.handleWebCleanupFinishedRuns)
	mux.HandleFunc("POST /activity/{id}/delete", s.handleWebDeleteActivityEvent)
	mux.HandleFunc("POST /activity/cleanup-finished", s.handleWebCleanupFinishedActivity)
	mux.HandleFunc("POST /activity/cleanup-all", s.handleWebCleanupAllActivity)
	...
	mux.HandleFunc("GET /partials/dashboard", s.handleWebPartialsDashboard)
	mux.HandleFunc("GET /partials/tasks", s.handleWebPartialsTasks)
	mux.HandleFunc("GET /partials/tasks-page", s.handleWebPartialsTasksPage)
