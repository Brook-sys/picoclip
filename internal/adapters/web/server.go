...
func (s *Server) Mount(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /runs/history/delete", s.handleWebDeleteRunsHistory)
	...
	mux.HandleFunc("POST /activity/history/delete", s.handleWebDeleteActivityHistory)
	...
	mux.HandleFunc("POST /runtimes/{id}/test-model", s.handleWebPostRuntimeTestModel)
